...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 cont">
            <h4 style="border-bottom: 1px solid #367be2; font-weight:600; color:#376fca; padding: 2px 0;">AMALY IŞLER</h4>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="container mt-4">
                ...
                <div class="accordion" id="bolumAccordion">
                    ...
                    $bolumQuery = "SELECT nomeri, MAX(Bolum_ady) AS Bolum_ady FROM amaly_data GROUP BY nomeri ORDER BY nomeri";
                    ...
                    if ($bolumResult->num_rows > 0) {
                        while ($bolum = $bolumResult->fetch_assoc()) {
                            ...
                            $paragrafQuery = "SELECT Paragraf_ady, Paragraf_no, PDF_file_ady FROM amaly_data WHERE nomeri = ? ORDER BY Paragraf_no";
