...
<div class="container-fluid ">
    <div class="row">
        <div class="col-md-12 cont">
            <h4 style="border-bottom: 1px solid #548db4; font-weight: 600; color:#706143; padding:2px 0;">
                <a href="#" class="mesele_baslik" style="text-decoration: none; color: inherit; cursor: pointer;">
                    Meseleler ýumuşlar</a>
            </h4>
    ...
    <div class="row" style="padding:20px 0; border-bottom: 0px solid #518fa8;">
        ...
        <div class="col-md-9 main_place">
            ...
            <form id="add_Product" enctype="multipart/form-data">
                ...
                <div class="row" style="margin-left:2px; background-color: #dbeaea;">
                    <div class="col-md-8" style=" padding-bottom: 10px; margin-top: 10px;">
                        ...
                        <div class="d-flex align-items-center;">
                            <!-- Input Alanı -->
                            <input type="text" id="bolum_input" data-file_data="meseleler_data_bolum" class="form-control " placeholder="Ýumuş belgisi"
                ...
                <div class="row" style="padding: 10px 0;">
                    ...
                    <div class="col">
                    <input type="hidden" data-file_data="meseleler_data" value="insert_meseleler_data.php" id="dosya_adi">
                        <label for="exampleFormControlSelect1">Ýumuş nomeri</label>
        ...
        <div class="col-md-3" id="select_parag" style="background-color: #fff; box-shadow: 0 3px 10px rgb(0 0 0 / 0.2); border-radius:4px">
            ...
            $sql = "SELECT DISTINCT nomeri, Bolum_ady, Paragraf_ady, Paragraf_no FROM meseleler_data ORDER BY nomeri";
...
<script>
    $(function() {
        $(document).on("click", ".paragraph_select", function(e) {
            ...
            $.ajax({
                url: "call_pages/meseleler_paragraph_data.php", // Veri çekeceğiniz PHP dosyası
                type: "POST",
                data: {
...
<script>
   $(function() {
    $(document).on("click", ".mesele_baslik", function(e) {
        e.preventDefault();
        ...
        $("#main_pl").load("call_pages/meseleler_paragraph_data.php", function(response, status, xhr) {
            if (status == "error") {
